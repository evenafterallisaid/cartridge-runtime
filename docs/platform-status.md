...
| Network ingress | Authenticated local command invocation works without guest sockets; an HTTP listener, TLS identity, remote clients, rate limits, streaming, and declared ingress policy are not implemented |
