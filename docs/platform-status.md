...
| Service-aware supervisor | Standalone replica lifecycle, restart reconciliation, process-level health, stale-supervisor detection, and readiness waits work; provider-first activation, typed service wiring, application probes, rolling replacement, idle suspension, cancellation trees, circuit breaking, and backpressure remain |
